...
![formula1](https://liger82.github.io/assets/img/post/20200419-NADST/nadst_1.png)
...
![figure1](https://liger82.github.io/assets/img/post/20200419-NADST/figure1_v2.png)
...
<img src="https://liger82.github.io/assets/img/post/20200419-NADST/context_encoder.png" alt="context_encoder" style="width:50%;"/>
...
![domain_slot_encoder](https://liger82.github.io/assets/img/post/20200419-NADST/domain_slot_encoder.png)
...
![attention1](https://liger82.github.io/assets/img/post/20200419-NADST/attention1.png)
...
![attention2](https://liger82.github.io/assets/img/post/20200419-NADST/attention2.png)
...
![attention3](https://liger82.github.io/assets/img/post/20200419-NADST/attention3.png)
...
![gate and fertility](https://liger82.github.io/assets/img/post/20200419-NADST/generate_fert_gate.png)
...
![state decoder 2](https://liger82.github.io/assets/img/post/20200419-NADST/state_decoder2.png)

예측된 state 의 마지막 확률값($$P_{state}$$)은 두 확률값의 가중치 합으로 정의된다.

![state decoder 3](https://liger82.github.io/assets/img/post/20200419-NADST/state_decoder3.png)
...
![state decoder 4](https://liger82.github.io/assets/img/post/20200419-NADST/state_decoder4.png)

## 3.4 Optimization

3 개의 loss(state, gate, fertility) 값의 가중치 합이 최소화되도록, 함께 학습하는 방식으로 모든 패러미터를 최적화하였다.

![opt](https://liger82.github.io/assets/img/post/20200419-NADST/optimization.png)
...
![dataset](https://liger82.github.io/assets/img/post/20200419-NADST/dataset.png)
...
![table2](https://liger82.github.io/assets/img/post/20200419-NADST/table2.png)
...
![table3](https://liger82.github.io/assets/img/post/20200419-NADST/table3.png)

* table 8은 모든 도메인에서 NADST 의 성능을 보여준다.

![table8](https://liger82.github.io/assets/img/post/20200419-NADST/table8.png)
...
![table4](https://liger82.github.io/assets/img/post/20200419-NADST/table4.png)

![figure2](https://liger82.github.io/assets/img/post/20200419-NADST/figure2.png)

![figure3](https://liger82.github.io/assets/img/post/20200419-NADST/figure3.png)
...
![table5](https://liger82.github.io/assets/img/post/20200419-NADST/table5.png)
...
![table6](https://liger82.github.io/assets/img/post/20200419-NADST/table6.png)
...
![figure4](https://liger82.github.io/assets/img/post/20200419-NADST/figure4.png)
